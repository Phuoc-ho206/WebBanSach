    ...
    <main class="page-content">
      ...
      <form method="post" class="card">
        ...
        <div class="card__body form">
          ...
          <div class="btn-group">
            <button class="btn btn--primary" type="submit"><?= $editCoupon ? 'Cập nhật mã giảm giá' : 'Thêm mã giảm giá' ?></button>
            <?php if ($editCoupon): ?><a class="btn btn--ghost" href="coupons.php">Hủy sửa</a><?php endif; ?>
          </div>
        </div>
      </form>
            ...
            ?>
              <tr>
                ...
                <td class="table__actions">
                  <a class="btn btn--sm btn--outline" href="coupons.php?edit=<?= h($coupon['VoucherID']) ?>">Sửa</a>
